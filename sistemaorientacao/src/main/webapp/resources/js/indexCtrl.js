...
.controller('indexCtrl', function() {
	...
	$scope.selected = function(curso) {
		...
		$scope.professor.curso = $scope.cursos1;
	}
	// Buscar Todos os Curso Cadastrados
	$http({
		method : 'GET',
		url : '/curso'
...
}).controller('orientacaoCtrl', function($scope, $http) {
	...
	$scope.profAndAlunosByCurso = function(orientacao) {
		var curso = orientacao.curso.nome;
		console.log(curso);
		// Professor Por Curso
		$http({
			method : 'GET',
